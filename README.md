...
To run python files, the virtual environment `.py_venv` should be activated first.  
It is created in `scripts/setup-dependencies.sh`.
...
2. Run python scripts (example below)
```console
