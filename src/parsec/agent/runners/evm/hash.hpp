...
#ifndef OPENCBDC_TX_SRC_PARSEC_AGENT_RUNNERS_EVM_HASH_H_
#define OPENCBDC_TX_SRC_PARSEC_AGENT_RUNNERS_EVM_HASH_H_
...
#endif // OPENCBDC_TX_SRC_PARSEC_AGENT_RUNNERS_EVM_HASH_H_
