...
TEST(runtime_locking_shard_test, basic_test) {
    ...
    auto shard = cbdc::threepc::runtime_locking_shard::impl(log, nullptr);
    ...
    maybe_success = shard.prepare(
        ...
        {{key, new_val}},
        [](const std::optional<
            cbdc::threepc::runtime_locking_shard::shard_error>& ret) {
...
TEST(runtime_locking_shard_test, lock_not_given_test) {
        ...
        [&](cbdc::threepc::runtime_locking_shard::interface::
            ...
            ASSERT_TRUE(
                std::holds_alternative<
                    cbdc::threepc::runtime_locking_shard::shard_error>(ret));
            ASSERT_EQ(
                std::get<cbdc::threepc::runtime_locking_shard::shard_error>(
                    ret)
                    .m_error_code,
    ...
    maybe_success = shard.prepare(
        ...
        0,
        {{key, new_val}},
        [](std::optional<cbdc::threepc::runtime_locking_shard::shard_error>
               ret) {
